...
| Script | What it does |
| --- | --- |
| `melos run setup` | **one-shot setup**: submodule checkout + bootstrap + all codegen — run after cloning, and again after any `git pull` that bumps the submodule pointer or dependencies |
